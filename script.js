...
const activityData = {
    ...
    images: [
        ...
        {src: 'assets/Actividad 3/automatizacion.png', desc: 'Ejemplo de automatización mostrando la secuencia de comandos encadenados, logs de ejecución y la interacción con la interfaz gráfica cuando corresponde; demuestra cómo se orquestan varias tareas automáticamente.'},
